...
/** Sidebar pour l'espace infirmier : formulaire, statistiques, import, base patients */
const NAV_ITEMS = [
    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <header className="sticky top-0 z-30 flex h-14 items-center border-b border-slate-200 bg-white px-4 shadow-sm lg:px-6">
        <h1 className="text-lg font-semibold text-slate-800">
          Tableau de bord infirmier — Statistiques hospitalières
        </h1>
      </header>
      <div className="flex flex-1 overflow-hidden">
        <aside className="flex w-56 flex-col border-r border-slate-200 bg-white">
          <nav className="flex flex-1 flex-col gap-1 p-3" aria-label="Navigation infirmier">
